...
const set_authorization = ({
  ...
  try {
    ...
    console.error('config', 'write authorization config failed:', err?.message)
  }
}
  ...
  try {
    if (exists(authorization_config_path)) {
      try {
        ...
        console.warn('config', `read config json file ${authorization_config_path} failed:`, err?.message)
      }
    }
  } catch (err) {
    console.error('config', 'read authorization config failed:', err?.message)
  }
  return {
    authorization_type,
    authorization,
...
const clear_authorization = () => {
  try {
    ...
    console.error('config', 'clear authorization config failed:', err?.message)
  }
}
...
const set_language = (language) => {
  try {
    ...
    console.error('config', 'write language config failed:', err?.message)
  }
}
  ...
  try {
    if (exists(language_config_path)) {
      try {
        ...
        console.warn('config', `read config json file ${language_config_path} failed:`, err?.message)
      }
    }
  } catch (err) {
    console.error('config', 'read language config failed:', err?.message)
  }
  if (!language) {
...
const clear_language = () => {
  try {
    ...
    console.error('config', 'clear language config failed:', err?.message)
  }
}
...
const set_core = ({
  ...
  try {
    ...
    console.error('config', 'write core config failed:', err?.message)
  }
}
  ...
  try {
    if (exists(core_config_path)) {
      try {
        ...
        console.warn('config', `read config json file ${core_config_path} failed:`, err?.message)
      }
    }
  } catch (err) {
    console.error('config', 'read core config failed:', err?.message)
  }
  // 系统类型强制修改
  if (platform_core_mode_must[process.platform]) {
    mode = platform_core_mode_must[process.platform]
...
const clear_core = () => {
  try {
    ...
    console.error('config', 'clear core config failed:', err?.message)
  }
}
...
const set_api = ({
  ...
  try {
    ...
    console.error('config', 'write api config failed:', err?.message)
  }
}
  ...
  try {
    if (exists(api_config_path)) {
      try {
        ...
        console.warn('config', `read config json file ${api_config_path} failed:`, err?.message)
      }
    }
  } catch (err) {
    console.error('config', 'read api config failed:', err?.message)
  }
  return {
    host,
  }
...
const clear_api = () => {
  try {
    ...
    console.error('config', 'clear api config failed:', err?.message)
  }
}
