...
const emailCodeReg = new RegExp(`^[A-Za-z0-9]+$`)
...
export const EmailTest = (v, must) => {
  return reg_test('email', v, 'string', emailReg, must)
}

export const EmailCodeTest = (v, must) => {
  return reg_test('email_code', v, 'string', emailCodeReg, must)
}
