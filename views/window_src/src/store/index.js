...
const store = createStore({
  state: {
    ...
    proxy_current_node_status: null,
  ...
  mutations: {
    ...
    loadSystem(state) {
      const setDevice = (state, info) => {
        ...
        state.channel_id = info.channel_id
        state.channel_hidden_nodes = info.channel_hidden_nodes
      }
    ...
    loadProxy(state) {
      const setBase = (state, info) => {
        ...
        state.proxy_current_node_status = info.current_node_status
