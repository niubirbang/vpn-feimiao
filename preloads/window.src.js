...
contextBridge.exposeInMainWorld('box_logger', {
  open: (...args) => invoke('logger.open', ...args),
  upload: (...args) => invoke('logger.upload', ...args),
})
...
contextBridge.exposeInMainWorld('box_core', {
  ...
  retestNodeDelay: (...args) => invoke('core.retest_node_delay', ...args),
...
contextBridge.exposeInMainWorld('box_api', {
  ...
  loginByDevice: (...args) => invoke('api.login_by_device', ...args),
